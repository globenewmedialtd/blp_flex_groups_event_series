...
/**
 * Class BlpEventContentVisibilityUpdate.
 *
 * @package Drupal\blp_flex_groups_event_series
 */
class BlpEventContentVisibilityUpdate {
  ...
  public static function batchUpdateGroupContentVisibility(Group $group, array $changed_visibility, array $new_options) {
    ...
    for ($i = 0; $i < $num_operations; $i++) {
      $operations[] = [
        '\Drupal\blp_flex_groups_event_series\BlpEventContentVisibilityUpdate::updateVisibility',
        [
          $entities[$i],
          $new_options,
        ],
    ...
    $batch = [
      ...
      'finished' => '\Drupal\blp_flex_groups_event_series\BlpEventContentVisibilityUpdate::updateVisibilityFinishedCallback',
    ];
