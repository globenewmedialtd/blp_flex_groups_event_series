...
namespace Drupal\blp_flex_groups_event_series\Access;
...
/**
 * Determines access to routes based project group membership and settings.
 */
class BlpFlexGroupsEventSeriesJoinPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_event_series_group_join_permission');
