...
class BlpFlexGroupsEventSeriesConfigOverride implements ConfigFactoryOverrideInterface {
  ...
  public function loadOverrides($names) {
    ...
    $filter_node_access = [
      'id' => 'blp_event_node_access',
      'table' => 'node_access',
      'field' => 'blp_event_node_access',
      'relationship' => 'none',
      'group_type' => 'group',
      'admin_label' => '',
      'operator' => '=',
      ...
      'plugin_id' => 'blp_event_node_access',
    ];
    ...
    foreach ($config_names as $config_name => $displays) {
      if (in_array($config_name, $names)) {
        ...
        foreach ($displays as $display) {
          $overrides[$config_name]['display'][$display]['display_options']['filters']['blp_event_node_access'] = $filter_node_access;
        }
      }
    }
    ...
    foreach ($config_names as $config_name) {
      if (in_array($config_name, $names)) {
        $overrides[$config_name] = [
          'dependencies' => [
            'config' => [
              'blp_event-group_membership' => 'group.content_type.blp_event-group_membership',
            ],
          ],
          'display' => [
            'default' => [
